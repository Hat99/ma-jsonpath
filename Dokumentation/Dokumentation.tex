...
\begin{lstlisting}
	...
	Erwartete Laufzeit im Ausgangsdatensatz:
	n = 5.000
	
	Erwartete Laufzeit im geänderten Datensatz:
	m*c = 2.032
...
\subsubsection{Vergrößern des Zeichensatzes}


Ansätze: m reduzieren -> nicht volle schlüssel cutten
c reduzieren -> schlüsselzeichensatz verringern (kann mehrdeutigkeiten bringen)
